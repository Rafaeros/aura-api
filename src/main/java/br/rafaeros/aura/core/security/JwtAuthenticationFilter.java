...
import com.fasterxml.jackson.databind.ObjectMapper; // Importante para gerar o JSON
import io.jsonwebtoken.ExpiredJwtException; // Importante para capturar o erro
