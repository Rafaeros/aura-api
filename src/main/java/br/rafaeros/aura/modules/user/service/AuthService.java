...
public class AuthService {
    ...
    @Transactional
    public AuthResponse activateAccount(FirstAccessRequest request) {
        ...
        return new AuthResponse(token, user.getUsername(), user.getEmail(), user.getRole().name(),
                isSettingsConfigured, user.isFirstAccess());
    }
    ...
    private void validateActivation(User user, FirstAccessRequest request) {
